...
<?php } ?>
	...
	if ( $include_seedprod_headline_sdk == true ) { 
	?>
<script src="<?php echo $plugin_url; ?>public/js/jquery.lettering.min.js" defer></script>
<script src="<?php echo $plugin_url; ?>public/js/jquery.textillate.min.js" defer></script>
<script src="<?php echo $plugin_url; ?>public/js/jquery.animation.min.js" defer></script>
	<?php 
	} 
