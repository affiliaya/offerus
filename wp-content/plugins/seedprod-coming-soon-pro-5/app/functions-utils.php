...
<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" class="sp-w-6 sp-fill-current "><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg> ',
		...
		// 	 'id'     => 47,
		// 	 'icon'   => '
		// 	 <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="sp-w-6 sp-fill-current">
	 ...
	 foreach($all_widgets as $k => $value){
		    if($k != 'WP_Widget_Custom_HTML'){
                $random_id = $random_id+10;
                $block_options[] = array("name" => $value->name,
                'is_pro' => true,
                'cat'    => 'wpw',
...
function seedprod_pro_wc_add_to_cart_redirect( $url ) {
	if ( ! isset( $_REQUEST['add-to-cart'] ) ||
		 ...
		 ! isset( $_REQUEST['sp-add-to-cart-redirect'] ) ) {
		return $url;
	}

	if ( $_REQUEST['sp-add-to-cart-redirect'] === 'cart' &&
		function_exists( 'wc_get_cart_url' ) ) {
			$url = wc_get_cart_url();
	}

	if ( $_REQUEST['sp-add-to-cart-redirect'] === 'checkout' &&
