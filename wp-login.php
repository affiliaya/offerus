...
<html lang="en-US">
	...
	<title>Log In &lsaquo; I Can Do So You Can Do &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=5.7.2" media="all">
	...
	<link rel="icon" href="./wp-content/uploads/2020/05/favicon-16x16-1.png" sizes="32x32">
<link rel="icon" href="./wp-content/uploads/2020/05/favicon-16x16-1.png" sizes="192x192">
<link rel="apple-touch-icon" href="./wp-content/uploads/2020/05/favicon-16x16-1.png">
<meta name="msapplication-TileImage" content="./wp-content/uploads/2020/05/favicon-16x16-1.png">
	</head>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to I Can Do So You Can Do</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/offerus\/wp-admin\/admin-ajax.php"}};
</script>
<script src="./wp-includes/js/wp-util.min.js?ver=5.7.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"4d3e8f12aa"};
</script>
...
<script type="text/javascript">var tcb_post_lists=JSON.parse('[]');</script>			<script>
			...
			<script type="text/javascript">/*<![CDATA[*/if ( !window.TL_Const ) {var TL_Const={"security":"134ec948cf","ajax_url":"\/\/localhost\/offerus\/wp-admin\/admin-ajax.php","action_conversion":"tve_leads_ajax_conversion","action_impression":"tve_leads_ajax_impression","custom_post_data":{"http_referrer":".\/wp-login.php"},"current_screen":{"screen_type":7,"screen_id":0},"ignored_fields":["email","_captcha_size","_captcha_theme","_captcha_type","_submit_option","_use_captcha","g-recaptcha-response","__tcb_lg_fc","__tcb_lg_msg","_state","_form_type","_error_message_option","_back_url","_submit_option","url","_asset_group","_asset_option","mailchimp_optin","tcb_token","tve_labels","tve_mapping","_api_custom_fields","_sendParams","_autofill"]};} else {ThriveGlobal.$j.extend(true, TL_Const, {"security":"134ec948cf","ajax_url":"\/\/localhost\/offerus\/wp-admin\/admin-ajax.php","action_conversion":"tve_leads_ajax_conversion","action_impression":"tve_leads_ajax_impression","custom_post_data":{"http_referrer":".\/wp-login.php"},"current_screen":{"screen_type":7,"screen_id":0},"ignored_fields":["email","_captcha_size","_captcha_theme","_captcha_type","_submit_option","_use_captcha","g-recaptcha-response","__tcb_lg_fc","__tcb_lg_msg","_state","_form_type","_error_message_option","_back_url","_submit_option","url","_asset_group","_asset_option","mailchimp_optin","tcb_token","tve_labels","tve_mapping","_api_custom_fields","_sendParams","_autofill"]})} /*]]> */</script>	<div class="clear"></div>
	</body>
	</html>